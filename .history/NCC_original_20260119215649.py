...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=_str2bool,
        default=True,
        help="use Heisenberg model (true/false)",
    )
    parser.add_argument("--trials", type=int, default=10000, help="NCC trials")
...
def main():
    ...
    def NCC_sampling(trials=100):
        ...
        # note the order, A first or B first
        ...
        return V_exact, V_list, V_average

    V_exact, V_list, V_average = NCC_sampling(trials=args.trials)
    print(np.linalg.norm(V_average - V_exact, 2))
